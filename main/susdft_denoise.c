...
"    - For type=swmean or swmedian output the mean or median respectively of the kept traces "
"      only if the current trace value was rejected, otherwise the original value is passed unchanged. ",
